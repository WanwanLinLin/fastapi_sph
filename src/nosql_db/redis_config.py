...
pool = redis.ConnectionPool(host="192.168.59.87", port=6379, db=3, decode_responses=True)
pool_2 = redis.ConnectionPool(host="192.168.59.87", port=6379, db=2, decode_responses=True)
pool_3 = redis.ConnectionPool(host="192.168.59.87", port=6379, db=1, decode_responses=True)
pool_4 = redis.ConnectionPool(host="192.168.59.87", port=6379, db=4, decode_responses=True)
